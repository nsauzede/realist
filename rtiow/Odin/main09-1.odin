...
main :: proc() {
	...
	fmt.printf("%d\n", 255);
	world := []Hittable{
		Sphere{Vec3{0, 0, -1}, 0.5, Material_Lambertian{Vec3{0.8, 0.3, 0.3}}},
		Sphere{Vec3{0, -100.5, -1}, 100, Material_Lambertian{Vec3{0.8, 0.8, 0.0}}},
		Sphere{Vec3{1, 0, -1}, 0.5, Material_Metal{Vec3{0.8, 0.6, 0.2}}},
		Sphere{Vec3{-1, 0, -1}, 0.5, Material_Metal{Vec3{0.8, 0.8, 0.8}}},
	};
	cam := Camera {
		Vec3{-2.,-1.,-1.},
		Vec3{4.,0.,0.},
